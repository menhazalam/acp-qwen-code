...
import { QwenCodeAgent } from "./agent.js";
...
export async function main() {
  ...
  log("Starting Qwen Code ACP Bridge...");
  ...
  try {
    ...
    new AgentSideConnection(
      (client) => new QwenCodeAgent(client),
    ...
    log("Qwen Code ACP Bridge is running");
